...
class CampusRoutingService {
  ...
  static const Map<int, DestinationInfo> destinations = {
    1: DestinationInfo(
      ...
      corridorSnapPoint: Offset(0.22, 0.38),
    ),
    2: DestinationInfo(
      id: 2,
      ...
      corridorSnapPoint: Offset(0.50, 0.45),
    ),
    3: DestinationInfo(
      id: 3,
      name: 'Block C / Workshop Block',
      shortName: 'Workshop',
      position: Offset(0.38, 0.28),
      corridorSnapPoint: Offset(0.38, 0.32),
    ),
    4: DestinationInfo(
      id: 4,
      name: 'Casting Yard',
      ...
      corridorSnapPoint: Offset(0.45, 0.28),
    ),
    5: DestinationInfo(
      id: 5,
      ...
      corridorSnapPoint: Offset(0.72, 0.22),
    ),
    6: DestinationInfo(
      id: 6,
      ...
      corridorSnapPoint: Offset(0.75, 0.30),
    ),
    7: DestinationInfo(
      id: 7,
      name: 'Ground / Playground',
      shortName: 'Ground',
      position: Offset(0.65, 0.15),
      corridorSnapPoint: Offset(0.62, 0.22),
    ),
    8: DestinationInfo(
      id: 8,
      name: 'Kuppi Veedu',
      shortName: 'Kuppi Veedu',
      position: Offset(0.70, 0.55),
      corridorSnapPoint: Offset(0.65, 0.52),
    ),
    9: DestinationInfo(
      id: 9,
      name: 'Canteen',
      shortName: 'Canteen',
      position: Offset(0.42, 0.58),
      corridorSnapPoint: Offset(0.42, 0.52),
    ),
    10: DestinationInfo(
      id: 10,
      name: 'Pond',
      ...
      corridorSnapPoint: Offset(0.55, 0.62),
    ),
    11: DestinationInfo(
      id: 11,
      name: 'Small Pond',
      shortName: 'Small Pond',
      position: Offset(0.48, 0.72),
      corridorSnapPoint: Offset(0.48, 0.65),
    ),
    12: DestinationInfo(
      id: 12,
      name: 'Staff Parking',
      ...
      corridorSnapPoint: Offset(0.20, 0.52),
    ),
    13: DestinationInfo(
      id: 13,
      name: 'Parking Area',
      ...
      corridorSnapPoint: Offset(0.18, 0.72),
    ),
    14: DestinationInfo(
      id: 14,
      name: 'Student Parking',
      shortName: 'Student Parking',
      position: Offset(0.25, 0.82),
      corridorSnapPoint: Offset(0.28, 0.75),
    ),
    15: DestinationInfo(
      id: 15,
      ...
      corridorSnapPoint: Offset(0.78, 0.35),
    ),
  };
